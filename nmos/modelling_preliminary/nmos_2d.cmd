...
grid remesh
implant Phosphorus dose=5e13<cm-2> energy=10<keV> tilt=0 rotation=0
...
grid remesh
implant Arsenic dose=4e15<cm-2> energy=75<keV> tilt=7<degree> rotation=-90<degree>

#N+ implantation and final RTA
diffuse temperature=1050<C> time=10.0<s>
